...
using Alloy_Vanilla.Models.Blocks;
...
namespace Alloy_Vanilla.Models.Pages
{
    ...
    public class StartPage : SitePageData
    {
        ...
        /// </summary>
        [Display(Name = "Benefits", Order = 40, GroupName = SystemTabNames.Content)]
        [Required]
        [CultureSpecific]
        [EditorDescriptor(EditorDescriptorType = typeof(CollectionEditorDescriptor<BenefitItemModel>))]
        public virtual IList<BenefitItemModel> BenefitsPropertyList { get; set; }
    }
}